var shop = [
    ...
    price: {oldUan: '4 333 грн',
            newUan: '3 799 грн'}, name: 'Motorola MOTO G4 (XT1622) Black'},
    ...
    {ratingRevievs: '198 отзывов', price: {oldUan: '3 495 грн', newUan: '2 995 грн'}, name: 'Lenovo K5 (A6020a40) Silver'}, {ratingRevievs: '352 отзыва', price: {oldUan: '9 799 грн', newUan: '7 999 грн'}, name: 'Apple iPhone 5s 16GB    Space Gray'},{ratingRevievs: '59 отзывов',price: '5 999 грн', name:    'Nokia 5 Dual Sim Tempered Blue'},
    ...
    {ratingRevievs: '177 отзывов',   price: '6 499 грн', name: 'Huawei P8 Lite 2017 White + УМБ Huawei    AP08Q + защитное стекло + чехол!'}, {ratingRevievs: '347 отзывов',   price: '4 299 грн', name: 'Xiaomi Redmi 4X 3/32GB Black    (Международная версия)'},
    ...
    {ratingRevievs: '14 отзывов',price: '11 499 грн', name: 'Apple iPhone 6 32GB Space Gray'}, {ratingRevievs: '70 отзывов',price: {oldUan: '7399 грн', newUan: '5 999 грн'}, name: 'Asus ZenFone 2 32GB (ZE551ML)    Black'},
    {ratingRevievs: '45 отзывов',price:'4 299 грн', name: 'Nokia 3    Dual Sim Silver White + сертификаты 500 грн!'}, {ratingRevievs: '376    отзывов',price: '3 899 грн', name: 'Meizu M3 Note 32GB Grey    (Международная версия)'}, {ratingRevievs: '111 отзывов',price:    {oldUan: '9 999 грн', newUan: '7 999 грн'}, name: 'Sony Xperia X Dual    (F5122) White'}, 
    {ratingRevievs: '40 отзывов',price: '2 222 грн', name:    'Lenovo Vibe C (A2020) Black + УМБ PowerPlant 5200 mAh в подарок!'}, {ratingRevievs: '93 отзыва', price: '18 999 грн', name: 'Apple iPhone 7    32GB Black'},
...
function bubbleSort(arr) {
    for (var i = 0, endI = arr.length - 1; i < endI; i++) {
        ...
        for (var j = 0, endJ = endI - i; j < endJ; j++) {
            if (+arr[j].ratingRevievs.replace(reg, '') > +arr[j + 1].ratingRevievs.replace(reg, '')) {
                var swap = arr[j];
                arr[j] = arr[j + 1];
                arr[j + 1] = swap;
                wasSwap = true;
